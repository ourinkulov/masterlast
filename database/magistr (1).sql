...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 05, 2021 at 12:31 PM
...
--
-- Stand-in structure for view `v_jntest`
-- (See below for the actual view)
--
CREATE TABLE `v_jntest` (
);
