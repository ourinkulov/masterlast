...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{url('/admin/dashboard')}}">
            ...
            <div class="mx-3 sidebar-brand-text">MAGISTRTRATURA  <sup></sup></div>
{{--            <div class="sidebar-brand-icon rotate-n-15">--}}
{{--                <i class="fas fa-user-graduate"></i>--}}
{{--            </div>--}}
        </a>
...
{{--                    <a class="collapse-item" href=""><i class="fa fa-chalkboard-teacher"></i><span for=""> Profil ma'lumotlari</span></a>--}}
...
{{--        </li>--}}
        <li class="nav-item">
            ...
            <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                <div class="py-2 bg-white rounded collapse-inner">
                                        <a class="collapse-item" href="{{url('/admin/teachers')}}"><i class="fa fa-chalkboard-teacher"></i><span for=""> O'qituvchilar</span></a>
                                        <a class="collapse-item" href="{{url('/admin/students')}}"><i class="fa fa-scroll"></i><span for="">  Tinglovchi</span></a>
                                        <a class="collapse-item" href="{{url('/admin/kafedras')}}"><i class="fa fa-atom"></i><span for="">  {{__('Kafedra')}}</span></a>
                                        <a class="collapse-item" href="{{url('/admin/fans')}}"><i class="fa fa-book"></i><span for="">  {{__('Fan')}}</span></a>
                                        <a class="collapse-item" href="{{url('/admin/mavzus')}}"><i class="fa fa-book"></i><span for="">  {{__('Mavzu')}}</span></a>
                                        <a class="collapse-item" href="{{url('/admin/groups')}}"><i class="fa fa-certificate"></i><span for=""> {{__('Guruh')}}</span></a>
{{--                                        <a class="collapse-item" href="{{route('user.loyiha')}}"><i class="fa fa-pencil-ruler"></i><span for="">  Loyihalar</span></a>--}}
        ...
        <li class="nav-item">
            ...
            <div id="collapseUtilities2" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                <div class="py-2 bg-white rounded collapse-inner">
                    ...
                    <a class="collapse-item" href="{{url('/admin/studyyear')}}"><i class="fa fa-hourglass"></i><span for="">  {{__(' O\'quv yili')}}</span></a>
                    <a class="collapse-item" href="{{url('/admin/semestrs')}}"><i class="fa fa-hourglass-end"></i><span for="">  {{__(' Semestr')}}</span></a>
                    <a class="collapse-item" href="{{url('/admin/comples')}}"><i class="fa fa-calendar-alt"></i><span for=""> {{__(' O\'quv reja')}}</span></a>
        ...
        <li class="nav-item">
            ...
            <div id="collapseUtilities1" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                <div class="py-2 bg-white rounded collapse-inner">
                    {{--                    <a class="collapse-item" href="{{route('user.dars')}}"><i class="fa fa-chalkboard-teacher"></i><span for=""> Maxorat darslari</span></a>--}}
                    <a class="collapse-item" href="{{url('/admin/oraliqnazorats')}}"><i class="fa fa-calendar-alt"></i><span for=""> {{__(' Oraliq nazorat')}}</span></a>
                    <a class="collapse-item" href="{{url('/admin/ongenerate')}}"><i class="fa fa-calendar-alt"></i><span for=""> {{__(' ON Generatsiya')}}</span></a>
                    <a class="collapse-item" href="{{url('/admin/createyakuniy')}}"><i class="fa fa-calendar-alt"></i><span for=""> {{__(' Yakuniy nazorat')}}</span></a>
        ...
        <li class="nav-item">
            ...
            <div id="collapseUtilities3" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                <div class="py-2 bg-white rounded collapse-inner">
                    {{--                    <a class="collapse-item" href="{{route('user.dars')}}"><i class="fa fa-chalkboard-teacher"></i><span for=""> Maxorat darslari</span></a>--}}
                    <a class="collapse-item" href="{{url('/admin/showjnmarks')}}"><i class="fa fa-calendar-alt"></i><span for=""> {{__(' Joriy nazorat')}}</span></a>
                    <a class="collapse-item" href="{{url('/admin/showonmarks')}}"><i class="fa fa-calendar-alt"></i><span for=""> {{__(' Oraliq nazorat')}}</span></a>
                    <a class="collapse-item" href="{{url('/admin/showallons')}}"><i class="fa fa-calendar-alt"></i><span for=""> {{__(' ON ')}}</span></a>
                </div>
            </div>
        </li>
...
<script type="text/javascript">
    window.livewire.on('oncreated',()=>{
        $('#createoraliqnazorat').modal('hide');
    });
    window.livewire.on('yncreated',()=>{
        $('#createyakuniynazorat').modal('hide');
    });
    window.livewire.on('ynupdated',()=>{
        $('#edityakuniynazorat').modal('hide');
    });
</script>
<script  type="text/javascript">
