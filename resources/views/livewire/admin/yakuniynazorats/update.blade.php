<div wire:ignore.self class="modal fade" id="edityakuniynazorat" tabindex="-1" role="dialog" aria-labelledby="edityakuniynazorat" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="edityakuniynazorat">O'zgartirish</h5>
