<div>
    @include('livewire.user.ynjurnals.create')
    @include('livewire.user.ynjurnals.update')
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <label>Yakuniy nazorat </label><br>
                        <select name="" id="" class="form-control" wire:model="ynid">
                            <option value="">YN tanlang</option>
                            @if(!empty($joriy))
                                @foreach($joriy as $item)
                                    <option value="{{$item->id}}">{{$item->yakuniyname}} </option>
                                @endforeach
                            @endif
                        </select>
                        {{--                        <button class="btn btn-primary" data-toggle="modal" data-target="#createJn">Joriy nazorat  kiritish</button>--}}
